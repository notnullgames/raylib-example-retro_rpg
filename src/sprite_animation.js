...
export default class SpriteAnimation {
  ...
  draw(x, y, scale, angle = 0, color = r.WHITE) {
    ...
    r.DrawTexturePro(this.image, { x: ox, y: oy, width: this.frameSize.x, height: this.frameSize.y }, { x, y, width: this.frameSize.x * scale, height: this.frameSize.y * scale }, { x: this.origin.x * scale, y: this.origin.y * scale }, angle, color)
  }
